...
window.addEventListener('load', function () {
    ...
    // Tambahkan class 'hide' untuk memulai transisi opacity
    preloader.classList.add('hide');

    // Setelah transisi selesai, hapus preloader dari DOM
    setTimeout(function() {
        preloader.style.display = 'none';
    }, 500); // Sesuaikan dengan durasi transisi opacity di CSS
});
